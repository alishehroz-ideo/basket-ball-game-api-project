...
namespace FortuneWheel
{
    public class GameController : MonoBehaviour
    {
        ...
        public void CallRewardedAdCost()
        {
            print("some");
        ...
        public void ClaimReward()
        {
            ...
            switch (PiecesOfWheel[rewardIndex].rewardCategory)
            {
                case RewardEnum.Gold:
                    {
                        PlayerPrefs.SetInt("TotalCoins", PlayerPrefs.GetInt("TotalCoins", 0) + PiecesOfWheel[rewardIndex].rewardAmount);
                        //UILibrary.instance.AddCoinFromUIEvent.Raise(PiecesOfWheel[rewardIndex].rewardAmount);
                ...
                case RewardEnum.Money:
                    {
                        //Nomi
                        //PlayfabGameController.Instance.AddPoint(PiecesOfWheel[rewardIndex].rewardAmount);
                    }
                    break;
                default:
                    Debug.Log("There is no reward for this angle, please check angles");
            ...
            //PlayFabManager.PFM.AdddDimond(PiecesOfWheel[rewardIndex].rewardAmount * rewardMultiplier);
